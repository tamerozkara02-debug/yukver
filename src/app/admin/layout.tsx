...
export default function AdminLayout({
  ...
  // If loading is finished and the user IS an admin, block access (FOR TESTING).
  if (isAdmin) {
     return (
      <div className="flex h-screen w-full items-center justify-center bg-background">
  ...
  // If loading is finished and the user IS NOT an admin, render the layout (FOR TESTING).
  return (
    <SidebarProvider>
      <Sidebar>
        <SidebarHeader>
